                    ...
                    with dpg.table_cell():
                        with dpg.drawlist(width=800, height=500):
                            with dpg.draw_layer():
                                ...
                                dpg.draw_text((214 + self.xOneOffset, 54), "1", color=(250, 250, 250, 255), size=50)

                                dpg.draw_line((300, 50), (300, 100), color=self.color, thickness=5)
                                dpg.draw_text((264 + self.xOneOffset, 54), "1", color=(250, 250, 250, 255), size=50)
                                ...
                                dpg.draw_text((414 + self.xOneOffset, 54), "1", color=(250, 250, 250, 255), size=50)
                                ...
                                dpg.draw_text((614 + self.xOneOffset, 54), "1", color=(250, 250, 250, 255), size=50)

                            with dpg.draw_layer():
                                dpg.draw_line((48, 50 + self.yOffset), (653, 50 + self.yOffset), color=self.color, thickness=5)
                                dpg.draw_line((50, 50 + self.yOffset), (50, 103 + self.yOffset), color=self.color, thickness=5)
                                dpg.draw_line((50, 100 + self.yOffset), (653, 100 + self.yOffset), color=self.color, thickness=5)
                                dpg.draw_line((650, 100 + self.yOffset), (650, 50 + self.yOffset), color=self.color, thickness=5)

                                dpg.draw_line((100, 50 + self.yOffset), (100, 100 + self.yOffset), color=self.color, thickness=5)
                                dpg.draw_text((64 + self.xOneOffset, 54 + self.yOffset), "1", color=(250, 250, 250, 255), size=50)

                                dpg.draw_line((150, 50 + self.yOffset), (150, 100 + self.yOffset), color=self.color, thickness=5)
                                dpg.draw_text((114 + self.xOneOffset, 54 + self.yOffset), "1", color=(250, 250, 250, 255), size=50)

                                dpg.draw_line((200, 50 + self.yOffset), (200, 100 + self.yOffset), color=self.color, thickness=5)
                                dpg.draw_text((164, 54 + self.yOffset), "0", color=(250, 250, 250, 255), size=50)

                                dpg.draw_line((250, 50 + self.yOffset), (250, 100 + self.yOffset), color=self.color, thickness=5)
                                dpg.draw_text((214 + self.xOneOffset, 54 + self.yOffset), "1", color=(250, 250, 250, 255), size=50)

                                dpg.draw_line((300, 50 + self.yOffset), (300, 100 + self.yOffset), color=self.color, thickness=5)
                                dpg.draw_text((264, 54 + self.yOffset), "0", color=(250, 250, 250, 255), size=50)

                                dpg.draw_line((350, 50 + self.yOffset), (350, 100 + self.yOffset), color=self.color, thickness=5)
                                dpg.draw_text((314, 54 + self.yOffset), "0", color=(250, 250, 250, 255), size=50)

                                dpg.draw_line((400, 50 + self.yOffset), (400, 100 + self.yOffset), color=self.color, thickness=5)
                                dpg.draw_text((364, 54 + self.yOffset), "0", color=(250, 250, 250, 255), size=50)

                                dpg.draw_line((450, 50 + self.yOffset), (450, 100 + self.yOffset), color=self.color, thickness=5)
                                dpg.draw_text((414 + self.xOneOffset, 54 + self.yOffset), "1", color=(250, 250, 250, 255), size=50)

                                dpg.draw_line((500, 50 + self.yOffset), (500, 100 + self.yOffset), color=self.color, thickness=5)
                                dpg.draw_text((464 + self.xOneOffset, 54 + self.yOffset), "1", color=(250, 250, 250, 255), size=50)

                                dpg.draw_line((550, 50 + self.yOffset), (550, 100 + self.yOffset), color=self.color, thickness=5)
                                dpg.draw_text((516 + self.xOneOffset, 54 + self.yOffset), "1", color=(250, 250, 250, 255), size=50)

                                dpg.draw_line((600, 50 + self.yOffset), (600, 100 + self.yOffset), color=self.color, thickness=5)
                                dpg.draw_text((564, 54 + self.yOffset), "0", color=(250, 250, 250, 255), size=50)

                                dpg.draw_text((614, 54 + self.yOffset), "0", color=(250, 250, 250, 255), size=50)
