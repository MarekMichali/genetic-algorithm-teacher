    ...
    def __init__(self):
        with dpg.mutex():
            ...
            with dpg.window(label="Menu", autosize=True, tag="mainWindow", pos=config.mainWindowDefaultPos):
                ...
                dpg.add_spacer(height=50)
                dpg.add_button(label="Start learning", width=config.mainWinButtonWidth,
                ...
                dpg.add_button(label="Tsp", width=config.mainWinButtonWidth,
                               height=config.mainWinButtonHeight, callback=self.show_tsp)
                dpg.add_button(label="Optymalizacja", width=config.mainWinButtonWidth,
